...
describe('EmailService', () => {
    ...
    let rateLimiter;
    beforeAll(() => {
        rateLimiter = new RateLimiter_1.RateLimiter(10, 60000);
        emailService = new EmailService_1.EmailService([new MockProvider1_1.MockProvider1(), new MockProvider2_1.MockProvider2()], rateLimiter);
    });
    afterAll(() => {
    ...
    it('should send an email successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const status = yield emailService.sendEmail({
            to: "test@example.com",
            subject: "Hello!",
